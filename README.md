...
=============================================================================
## 项目经历
__2021.8-至今__　人机交互中问答确信度与视线、心拍的关系研究  
**［项目介绍］** 东京都立大学智能人机交互研究室修士研究项目  
**［项目中的角色和任务］**  研究员 
完成操控ebbi机器人进行对话都程序。辅助完成收集实验数据代码，并进行实验  
在与Kebbi机器人进行对话，使用Tobbi眼镜和Polar H10收集视线和ECG数据，记录被实验者的回答确信度
对视线和ECG数据进行处理，丢弃无用特征并添加新的数据特征  
使用多种机器学习算法对时间序列数据进行分类学习  
**［关键词］** Eye-Tracking、ECG、Confidence、Machine Learning  
